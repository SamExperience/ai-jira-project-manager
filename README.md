# AI Jira Project Manager: AI | Telegram Bot | n8n
...
## Workflow Schema
![n8n Workflow Schema](workflow-screenshot-AI%20Jira%20Project%20Manager.png)
...
* **List Tasks**: Send `@lista`
  * *Result:* The bot returns a formatted list of all your active tasks.

## Technical Architecture
1. **Trigger**: A scheduled trigger polls the Telegram API every 5 seconds.
2. **Filtering**: A gateway node validates incoming data.
3. **AI Reasoning**: An AI Agent (Gemini) interprets intent and translates content.
